 ...
 * @author PY7
 */
public final class DataBarang_ extends javax.swing.JFrame {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            ...
            try (PreparedStatement p = c.prepareStatement(sql)) {
                ...
                Logger.getLogger(DataBarang_.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//        clear();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataBarang_.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
